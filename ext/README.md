...
//
// Streaming bursts are also supported. keep CS_N low past byte 4 and
// continue clocking SCK. each additional byte is treated as another data
// byte with auto-incremented address. CS_N rising ends the burst.
//
...
// internal byte counter resets cleanly when not streaming.
